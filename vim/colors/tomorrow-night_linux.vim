...
let s:foreground = "aca9a9"
let s:background = "1d1f21"
" let s:background = "1a1c1e"
let s:selection = "373b41"
let s:line = "282a2e"
" let s:comment = "969896"
let s:comment = "807b7b"
" let s:red = "cc6666"
let s:red = "ba6666"
let s:orange = "ae935f"
" let s:orange = "af8700"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
    ...
    call <SID>X("Folded", s:comment, s:background, "")
    call <SID>X("FoldColumn", s:red, s:background, "")
    if version >= 700
    ...
    call <SID>X("Todo", s:selection, s:background, "")
    call <SID>X("Title", s:selection, "", "")
...
hi! errormsg ctermfg=darkred ctermbg=235
highlight LineNr       ctermbg=235 ctermfg=243
...
highlight IncSearch    ctermbg=235   ctermfg=1
highlight Search       ctermbg=1   ctermfg=235
hi MatchParen cterm=none ctermbg=235 ctermfg=137
